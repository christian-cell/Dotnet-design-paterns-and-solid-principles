namespace Builder
{
    ...
    // to be recursive we create PersonBuilder and we limit the this class
    ...
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Called("dimitri");*/ // in this case you are not allowed to use WorkAsA becouse you are instantiating PersonJobBuilder and not PersonInfoBuilder
